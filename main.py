...
if not os.path.exists(cred_path):
    print("WARNING: Service account key not found. Firestore integration will not work.")
...
def diagnose():
    ...
    try:
        ...
        diagnosis_data['diagnosis_result'] = predicted_label
...
def get_symptom_names():
    symptom_names = [
        "gejala_1 (kepala terasa sakit/pusing)", "gejala_2 (mata sering nyeri)", "gejala_3 (mata merah)",
        "gejala_4 (penyempitan sudut pandang)", "gejala_5 (mata sering berair)", "gejala_6 (sering muntah tiba-tiba)",
        "gejala_7 (melihat pelangi melingkar di lampu atau pusat cahaya)", "gejala_8 (tekanan pada mata meningkat)",
        "gejala_9 (sering merasa mual)", "gejala_10 (penglihatan suka berkabut)", "gejala_11 (memiliki penyakit mata bawaan)",
        "gejala_12 (bilik pada depan mata terbuka)", "gejala_13 (bilik pada depan mata sempit)",
        "gejala_14 (mata pernah berbenturan dengan benda)", "gejala_15 (memiliki riwayat penyakit diabetes)",
        "gejala_16 (memiliki riwayat penyakit hipertensi)", "gejala_17 (mata sering gatal)",
        "gejala_18 (penglihatan kabur atau buram)", "gejala_19 (sering muncul bintik-bintik hitam pada pandangan)",
        "gejala_20 (kornea mata tidak jernih)"
    ]
